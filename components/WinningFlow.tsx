        ...
        <Card className="bg-black/90 border-4 border-yellow-500 p-4 md:p-8 neon-glow-yellow">
          {isJackpot && (
            ...
            >
              ...
              <motion.h1
                className="text-5xl md:text-6xl neon-text-yellow text-yellow-300 mb-4"
                animate={{
                  textShadow: [
                    "0 0 20px #ffd700",
                    "0 0 40px #ffd700",
              ...
              <AnimatePresence>
                {showPrize && (
                  ...
                  >
                    <div className="text-6xl md:text-8xl text-yellow-300 neon-text-yellow mb-6 pulse-glow">
                      {formatNumber(entry.prizeAmount || 0)} CSPR
                    </div>
                    <p className="text-xl md:text-3xl text-white mb-8">
                      You won the entire prize pool! 🏆
                    </p>
              ...
              <Button
                onClick={onClose}
                className="casino-gradient neon-glow-yellow hover:scale-110 transition-transform text-lg md:text-2xl px-8 md:px-12 py-4 md:py-6 cursor-pointer text-white rounded-xl"
              >
          ...
          {isConsolation && (
            ...
            >
              ...
              <motion.h1
                className="text-4xl md:text-6xl neon-text-cyan text-cyan-300 mb-4"
                animate={{
                  textShadow: [
                    "0 0 20px #00ffff",
                    "0 0 40px #00ffff",
              ...
              <AnimatePresence>
                {showPrize && (
                  <motion.div
                    ...
                    transition={{ type: "spring", duration: 0.5 }}
                  >
                    <div className="text-5xl md:text-7xl text-cyan-300 neon-text-cyan mb-6 pulse-glow">
                      {formatNumber(entry.prizeAmount || 0)} CSPR
                    </div>
              ...
              <Button
                onClick={onClose}
                className="casino-gradient neon-glow-cyan hover:scale-110 transition-transform text-lg md:text-2xl px-8 md:px-12 py-4 md:py-6 cursor-pointer text-white rounded-xl"
              >
                <Sparkles className="w-5 h-5 md:w-6 md:h-6 mr-2" />
                Awesome! 🎊
              </Button>
          ...
          {!isWin && (
            ...
            >
              ...
              <h1 className="text-3xl md:text-5xl text-gray-300 mb-4">
              ...
              <div className="bg-black/40 rounded-xl p-4 md:p-6 mb-6 md:mb-8 border border-gray-500/30">
                <div className="text-sm md:text-base text-gray-400 space-y-2">
                  ...
                  <div className="pt-2 md:pt-3 border-t border-gray-600">
                    ...
                    <div className="flex items-center justify-center gap-2 text-[10px] md:text-sm flex-wrap">
              ...
              <Button
                onClick={onClose}
                className="casino-gradient neon-glow-pink hover:scale-110 transition-transform text-lg md:text-2xl px-8 md:px-12 py-4 md:py-6 cursor-pointer text-white rounded-xl"
              >
                <Sparkles className="w-5 h-5 md:w-6 md:h-6 mr-2" />
                Try Again!
              </Button>
